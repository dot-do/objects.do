 ...
 *
 * Self-contained copy of digital-objects/linguistic.ts so objects.do
 * has zero runtime dependencies beyond Hono. Keep in sync with canonical
 * source: .org.ai/primitives/packages/digital-objects/src/linguistic.ts
 *
